...
export const Header = ({ hasPendingGift, onOpenUnwrapModal }) => {
    ...
    return (<header className="container mx-auto p-4 flex justify-between items-center">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => navigate('/')} role="button" aria-label="Go to home page">
              <a href="/" className="flex items-center gap-2">
                  {/* Use Next.js Image component for the logo */}
                  <img src="/images/ItizaLogo.png" // Path to your logo in public/images
     alt="Itiza Logo" width={65} // Adjust width as needed

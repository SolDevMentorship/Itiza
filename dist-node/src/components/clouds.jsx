export function Clouds() {
    return (<div className="fixed inset-0 pointer-events-none overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-40">
        {Array.from({ length: 8 }, (_, i) => (<div key={i} className="absolute bg-white/80 rounded-full blur-md" style={{
      ...
      <div className="absolute bottom-0 left-0 right-0 h-40">
        {Array.from({ length: 8 }, (_, i) => (<div key={i} className="absolute bg-white/70 rounded-full blur-md" style={{

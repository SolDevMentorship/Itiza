...
//  */
// function determineAllowOrigin(originHeader: string | undefined) {
...
//   const allowOriginHeader = determineAllowOrigin(req.headers.origin as string | undefined);
...
//         console.log(
//           `[${now()}] paystack -> GET ${PAYSTACK_BASE}/transaction/verify/${encodeURIComponent(
//             reference
//           )}`
//         );

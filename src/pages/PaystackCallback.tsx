...
export default function PaystackCallback() {
  ...
  useEffect(() => {
    (async () => {
      ...
      let ref: string | null = q.get("reference");
      ...
      try {
        ...
        setMessage(
          "Payment verification failed or is still pending. If you were charged, we'll finalize the order shortly. Contact support if the money was deducted."
        );
      } catch (err) {
